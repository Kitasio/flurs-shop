    ...
    <span className="text-sm text-stone-500 ml-2">
      ...
      <div className="space-y-6">
        ...
        <button
         ...
         className="w-full text-[#404D30] hover:text-white transition duration-300 cursor-pointer border-1 border-[#404D30] hover:bg-[#404D30] focus:ring-4 focus:outline-none focus:ring-[#404D30] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
        >
          ADD TO CART
        </button>
